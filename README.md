...
It is the one you can find in https://thumbsupuk.com/Products/Mini_Arcade_Machine . There is a more recent version, which you can distinguish because it doesn't say 'orb Gaming' on the front, and the games menu isn't a list of pages with eight games per page, but instead a menu separated by game genre.
